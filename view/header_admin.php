...
while($row=mysqli_fetch_assoc($result)){
	...
	if($_status=="Payments"){
		...
		$sql1="select student.index_number as std_index,student.full_name as std_name,payment_notifications.month as due_month,payment_notifications.year as due_year,payment_notifications.id as notifi_id
...
function viewAllNotifi(){
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
    	...
    	xhttp.open("GET", "all_notifications1.php", true);												
  		xhttp.send();
}
