...
$sql="select grade.name as g_name,subject.name as s_name,teacher_salary_history.subject_fee as s_fee,teacher_salary_history.subtotal as s_sub,teacher_salary_history.student_count as s_count
