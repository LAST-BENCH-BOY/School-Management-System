	...
	var xhttp = new XMLHttpRequest();//MSK-00116-Ajax Start
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById("full_name1").value =myArray1[2];
...
//MSK-000098-form2 submit
	...
	if(full_name == '' || full_name == '' || address == '' || phone == '' || email == '' || gname == '' || gaddress == '' || gphone == '' || gemail == '' ||telformat.test(phone) == false || mailformat.test(email) == false ){
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById("full_name2").innerHTML =myArray1[2];
  		...
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(d1 < 5){
					...
					document.getElementById('currentSalary').innerHTML="Your Salary will genarate on"+SalaryGDate;//7th July 2021 kiyala hadaganna balanna
					document.getElementById('currentPaid').innerHTML = "No Data..!";
					document.getElementById('dueAmount').innerHTML = "No Data..!";
