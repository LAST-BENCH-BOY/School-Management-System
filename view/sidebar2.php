...
?>      
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="my_subject2.php">
            <i class="fa fa-graduation-cap"></i> <span>My Subject</span>
          </a>
        </li>
        ...
        <li>
          <a href="my_attendance_history2.php">
            <i class="fa fa-graduation-cap"></i> <span>My Attendance</span>
          </a>
        </li>
