        ...
        <li>
         ...
         <li>
          <a href="all_teacher1.php">
            <i class="fa fa-user"></i> <span>My Teacher</span>
          </a>
        </li>
        <li>
          <a href="all_subject1.php">
            <i class="fa fa-book"></i> <span>My Subject</span>
          </a>
        </li>
        <li>
          <a href="all_timetable1.php">
            <i class="fa fa-calendar-plus-o"></i> <span>My Timetable</span>
          </a>
        </li>
